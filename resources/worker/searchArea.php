...
function searchArea(){
    ...
    $sql = "SELECT id,name,mobile,gender,age,area,profession_id FROM candidates WHERE profession_id =:profession_id AND area IN (SELECT area FROM areas Where user) "
                            .$age_str
                            .$area_str
                            .$gender_str;
    try {
